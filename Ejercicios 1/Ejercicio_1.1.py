...
#calclando el porcentaje de tiempo vacio
...
print("----------------------------")
#Mostrando la cantidad de ejercicios vacios que se remueven(Ejercicio B)
...
print(f"Ver 10 horas de otros curso equivale a ver {dalto_curso * 100 // otros_cursos_promedio / 10} horas del cursos de dalto")
print("-----------------------------")